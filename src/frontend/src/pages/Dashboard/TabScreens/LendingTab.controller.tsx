    ...
    return (
        <TabWrapperStyled backgroundImage="dashboard_lendingTab_bg.png">
            ...
            <div className="descr">
                ...
                <div className="text">
                    Mavryk Finance allows its users to put up existing crypto-assets as collateral for a loan, up to a
                    50% loan-to-value
                    ratio. Likewise, suppliers can loan out their crypto-assets to earn interest.{' '}
