...
type AdminViewProps = {
    ...
    handleCloseUsersEmptyVaults: () => void
}
...
export const AdminView = ({
    ...
    return (
        <AdminStyled>
            ...
            <Button text={'Add All Collateral tokens'} kind='actionPrimary'
            ...
            <Button text={'Close User\'s empty vaults'} kind='actionPrimary' onClick={handleCloseUsersEmptyVaults}/>
        </AdminStyled>
    )
}
