...
export const closeAllOfUsersEmptyVaults = (accountPkh?: string) => async (dispatch: AppDispatch, getState: GetState) => {
    const state: State = getState()
    ...
    const vaultsMapper = state.loans.vaults.vaultsMapper
