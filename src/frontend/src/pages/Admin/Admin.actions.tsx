...
export const ChangeAllAdminsFromGovernance = (accountPkh?: string) => async (dispatch: AppDispatch, getState: GetState) => {
  const state: State = getState()
  ...
  try {
    ...
    //const govProxyContract = await state.wallet.tezos?.wallet.at(state.contractAddresses.governanceAddress.address)
    const batch = await state.wallet.tezos?.wallet.batch()
      .withContractCall(govProxyContract.methods.setContractAdmin('KT1FFHgu19NB1fbxJy8cDKh55NXtFoX5xhNA', 'KT1GdqT3Kw278HkFuwTHeaJGC3FxCu5YRVTT'))
      .withContractCall(govProxyContract.methods.setContractAdmin('KT1FGpHmPmGPQre6CdJWirW54yarAE69AC6v', 'KT1GdqT3Kw278HkFuwTHeaJGC3FxCu5YRVTT'))
      .withContractCall(govProxyContract.methods.setContractAdmin('KT1GAPXe8HpcmpGS4UqR7dtTUYttsBe8F21Q', 'KT1GdqT3Kw278HkFuwTHeaJGC3FxCu5YRVTT'))
      .withContractCall(govProxyContract.methods.setContractAdmin('KT1SgajykE35iUXNU5oq1v8BPeSWhjBemSts', 'KT1GdqT3Kw278HkFuwTHeaJGC3FxCu5YRVTT'))
      .withContractCall(govProxyContract.methods.setContractAdmin('KT1TDWUGcxattXbG4dSawEpGr7EgZNdPF9Ee', 'KT1GdqT3Kw278HkFuwTHeaJGC3FxCu5YRVTT'))
    //   .withContractCall(govProxyContract.methods.setContractAdmin('KT1TGxgh9tRiR3LjS86wqEK2hih57Y1Cnc9Y', 'KT1Wu7Ww63jXYADFwhXyxvxeSVKKSZKVGY7m'))
    //   .withContractCall(govProxyContract.methods.setContractAdmin('KT1G3jTf6ULxBVt8Dxo8HfhxZGS2Fwhk8ZJR', 'KT1Wu7Ww63jXYADFwhXyxvxeSVKKSZKVGY7m'))
    //   .withContractCall(govProxyContract.methods.setContractAdmin('KT1Hf24mbEZfSsBAQEvpcRQEpYzvqiU4j131', 'KT1Wu7Ww63jXYADFwhXyxvxeSVKKSZKVGY7m'))
    //   .withContractCall(govProxyContract.methods.setContractAdmin('KT1NQW18AMX4QqWgR49AcibN2S5oPFzemaqh', 'KT1Wu7Ww63jXYADFwhXyxvxeSVKKSZKVGY7m'))
