        ...
        <PositionTableStyled>
            {markets.length ? (
                <>
                                        ...
                                        >
                                            <TableCell width="15%">
                                                <div className="cell-content row with-icon asset-name">
                                                    <ImageWithPlug imageLink={loanTokenData.icon}
                                                                   alt={`${loanTokenData.symbol} logo`}/>
                                                ...
                                                <div className="cell-content" style={{marginRight: '20px'}}>
                                                    {lendingItem ? (
                                                        <>
                                                            ...
                                                            <CommaNumber value={lendValue * loanTokenData.rate}
                                                                         beginningText="$"/>
                                                    ...
                                                    {marketVaultsUserData ? (
                                                        <>
                                                            ...
                                                            <CommaNumber value={marketVaultsUserData.borrowedAmount}
                                                                         beginningText="$"/>
                                                            <div
                                                                className={`vault-status ${averageVaultStatus.status}`}>
                                                                {averageVaultStatus.text}
                                                            </div>
                                                            <Link
                                                                to={`/loans/${loanTokenData.symbol}/${BORROW_TAB_ID}`}>
                                                                <Button kind={BUTTON_SIMPLE}>View</Button>
                                                            </Link>
                                                        </>
                                                    ) : (
                    ...
                    <Pagination itemsCount={markets?.length ?? 0} listName={LOANS_POSITION_TABLE}
