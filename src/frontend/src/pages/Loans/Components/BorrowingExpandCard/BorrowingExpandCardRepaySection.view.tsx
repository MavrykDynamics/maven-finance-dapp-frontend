...
export const BorrowingExpandCardRepaySection = (props: Props) => {
  ...
  const { futureBorrowCapacity, futureCollateralRatio, futureTotalOustanding } = getVaultFutureStatsAfterRepay({
    currentCollateralBalance: collateralBalance,
    currentTotalOutstanding: totalOutstanding,
    inputAmount,
    availableLiquidity,
    tokenRate: borrowedTokenRate,
  })
    ...
    <VaultOverview>
      <div className="line">
        ...
        <ThreeLevelListItem className="right">
          ...
          <CommaNumber value={collateralBalance} className="value" beginningText="$" decimalsToShow={2} />
        </ThreeLevelListItem>
      </div>
