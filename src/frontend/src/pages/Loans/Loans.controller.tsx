                            ...
                            return (
                                <MarketOverview key={`${name}-${symbol}`}>
                                    <div className="asset-info">
                                        ...
                                        {rate ? (
                                            <div className="rate">
                                                <CommaNumber beginningText="$" value={rate} decimalsToShow={4}
                                                             showDecimal/>
                                            </div>
                                        ) : null}
                                    </div>
                                    ...
                                    <div className="content-wrapper">
                                        <div className="row">
                                            <ThreeLevelListItem>
                                                ...
                                                {rate ? <CommaNumber beginningText="$" value={totalLended * rate}
                                            ...
                                            <ThreeLevelListItem>
                                                ...
                                                <div className="value">
                                                    <CommaNumber value={lendingAPY} className="value"
                                                                 endingText="%"/>{' '}
                                                    <CustomTooltip
                                                        iconId="info"
                                            ...
                                            <ThreeLevelListItem>
                                                ...
                                                <CommaNumber value={totalFeesEarned} className="value"
                                                             beginningText="$"/>
                                            </ThreeLevelListItem>
                                            <ThreeLevelListItem>
                                        ...
                                        <div className="row">
                                            <ThreeLevelListItem>
                                                ...
                                                {rate ? <CommaNumber beginningText="$" value={totalBorrowed * rate}
                                                                     className="value"/> : null}
                                            ...
                                            <ThreeLevelListItem>
                                                ...
                                                <div className="value">
                                                    <CommaNumber value={borrowAPR} className="value"
                                                                 endingText="%"/>{' '}
                                                    <CustomTooltip
                                                        iconId="info"
                                                        defaultStrokeColor={colors[themeSelected].dataColor}
                                            ...
                                            <Link to={`/loans/${symbol}/${BORROW_TAB_ID}`}>
                                                <Button text="Borrow" kind={ACTION_PRIMARY} iconAfter
                                                        icon="arrowRight"/>
                                            </Link>
                                        </div>
                                    </div>
