...
export class StakeProviderClass extends React.Component<Props, State> {
  ...
  stakeMVK = async (
    ...
    try {
      ...
      const batch = mvkTokenContract && doormanContract && (await tezos.wallet.batch(batchArr))
