import { GetTreasurySmvnBalancesQuery, GetTreasuryStorageDataQuery, Treasury } from 'utils/__generated__/graphql'
...
export type TreasuryGQLData = GetTreasuryStorageDataQuery & GetTreasurySmvnBalancesQuery
