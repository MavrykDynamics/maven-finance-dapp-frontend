...
export const M_TOKEN_BALANCE = (asset: string) => `Your current balance of m${asset} you have in the pool. This is the same amount that you have the in Supplied Amount.`
export const SUPPLIED_AMOUNT = (asset: string) => `Total ${asset} you have supplied to the pool included yield earned on your deposit.`
export const EARN_APY = ''