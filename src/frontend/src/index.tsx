...
import ContractErrorProvider from 'providers/ContractErrorProvider/contractError.provider'
      ...
      <ApolloProvider client={client}>
        <Provider store={store}>
          ...
          <DarkThemeProvider>
            <GlobalStyle />
            <ToasterProvider>
              <ContractErrorProvider>{isMobile ? <Mobile /> : <App />}</ContractErrorProvider>
              <ToasterMessages />
            </ToasterProvider>
          </DarkThemeProvider>
          {/* </PersistGate> */}
